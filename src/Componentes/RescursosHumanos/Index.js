import '../RescursosHumanos/Style.css';
import '../reset.css';
import RescursoHumano from './gestao-pessoas.jpg';
...
export function RescursosHumanos() {
    return (
        <div className='alinha-curso-enfermage'>
            ...
            <div class="alinha-dados-curso-enfermagem">
                <div class="foto-curso-Enfermagem">
                    <img src={RescursoHumano} alt="Curso de RescursosHumanos" />
                </div>
