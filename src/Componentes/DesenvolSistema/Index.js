import '../DesenvolSistema/Style.css';
import '../reset.css';
import DesenvolvimentoSist from './DesenvolSistema.jpeg';
...
export function DesenvolSistema() {
    return (
        <div className='alinha-curso-enfermage'>
            ...
            <div class="alinha-dados-curso-enfermagem">
                <div class="foto-curso-Enfermagem">
                    <img src={DesenvolvimentoSist} alt="Curso de DesenvolSistema" />
                </div>
